 ...
 */
export declare class LibSQLVectorStore extends VectorStore {
     ...
     */
    static fromTexts(texts: string[], metadatas: object[] | object, embeddings: EmbeddingsInterface, options: LibSQLVectorStoreArgs): Promise<LibSQLVectorStore>;
    /**
     ...
     * @returns {Promise<LibSQLVectorStore>} A new LibSQLVectorStore instance.
     */
    static fromDocuments(docs: Document[], embeddings: EmbeddingsInterface, options: LibSQLVectorStoreArgs): Promise<LibSQLVectorStore>;
}
